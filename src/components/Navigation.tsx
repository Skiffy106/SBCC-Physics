...
const Navigation: React.FC = () => {
    ...
    return (
        <nav className="flex flex-row justify-between items-center relative z-20 py-4 px-8 lg:px-16 xl:px-32 2xl:48 border-b border-slate-50">
            <div className="absolute top-0 left-0 w-full h-full bg-sbcc-red z-20" aria-hidden="true"></div>
            <a href="#" className="flex flex-row items-center space-x-4 z-40">
            ...
            <div className="block md:hidden" aria-label="Mobile Navigation">
                <button
                    className="flex h-12 w-12 flex-col justify-between items-center z-40 p-2 m-0"
                    onClick={handleClick}
